  ...
  return (
    <main className="px-4 pb-12 pt-6 sm:px-6 lg:px-8">
      <section className="mx-auto max-w-[1500px]">
        <MarketingHeroSplit
          badge={workspaceDashboardContent.agent.badge}
          title={workspaceDashboardContent.agent.title}
          description={workspaceDashboardContent.agent.description}
          asideEyebrow={workspaceDashboardContent.agent.asideEyebrow}
          asideTitle={workspaceDashboardContent.agent.asideTitle}
          asideDescription={workspaceDashboardContent.agent.asideDescription}
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 xl:grid-cols-5">
          {workspaceDashboardContent.agent.items.map((item) => (
