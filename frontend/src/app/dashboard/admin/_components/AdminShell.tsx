...
import { adminSections, adminShellContent } from '@/data/content/admin';
      ...
      <div className="grid gap-6 min-[1800px]:grid-cols-[300px_minmax(0,1fr)]">
        <aside className="rounded-[2rem] border border-[rgba(231,220,200,0.95)] bg-[rgba(255,255,255,0.92)] p-4 shadow-[0_20px_60px_rgba(9,21,64,0.08)] backdrop-blur-sm min-[1800px]:sticky min-[1800px]:top-6 min-[1800px]:h-[calc(100vh-3rem)] min-[1800px]:overflow-auto">
          <div className="rounded-[1.5rem] bg-[linear-gradient(180deg,#071426_0%,#0d2342_100%)] p-5 text-white shadow-luxury">
            ...
            <div className="mt-4 text-xs uppercase tracking-[0.35em] text-[#f2cf5b]/80">{adminShellContent.portalEyebrow}</div>
            <div className="mt-3 text-2xl font-semibold leading-tight">{adminShellContent.portalTitle}</div>
            <p className="mt-2 text-sm text-white/72">{adminShellContent.portalDescription}</p>
          </div>
          ...
          <div className="mt-4 hidden rounded-[1.5rem] border border-[rgba(231,220,200,0.95)] bg-[rgba(247,243,234,0.86)] p-3 min-[1800px]:block">
            <div className="grid gap-2">{adminSections.map((item) => <NavLink key={item.href} {...item} />)}</div>
          </div>
          ...
          <details className="group mt-4 overflow-hidden rounded-[1.5rem] border border-[rgba(231,220,200,0.95)] bg-[rgba(255,255,255,0.96)] min-[1800px]:hidden">
            <summary className="flex cursor-pointer list-none items-center justify-between px-4 py-4 text-sm font-semibold text-[#08122c]">
              <span>{adminShellContent.navigationLabel}</span>
          ...
          <div className="mt-4 rounded-[1.5rem] border border-[rgba(231,220,200,0.95)] bg-[rgba(255,255,255,0.96)] p-4">
            <div className="section-label">{adminShellContent.accountLabel}</div>
            <div className="mt-3 text-sm font-semibold text-[#08122c]">{adminShellContent.accountRole}</div>
            <div className="text-xs text-slate-500">{adminShellContent.accountEmail}</div>
        ...
        <section className="min-w-0">
          <div className="rounded-[2.25rem] border border-[rgba(231,220,200,0.95)] bg-[linear-gradient(180deg,rgba(255,255,255,0.95),rgba(247,243,234,0.88))] p-5 shadow-[0_24px_80px_rgba(9,21,64,0.10)] backdrop-blur-sm sm:p-6 lg:p-8">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                <div className="text-xs uppercase tracking-[0.35em] text-[#b98a3d]">{adminShellContent.portalEyebrow}</div>
              ...
              <div className="flex flex-wrap gap-3">
                <div className="rounded-full border border-[rgba(231,220,200,0.95)] bg-[rgba(247,243,234,0.86)] px-4 py-2 text-sm text-slate-500 shadow-soft">{adminShellContent.actions[0]}</div>
                <div className="rounded-full border border-[rgba(231,220,200,0.95)] bg-[rgba(247,243,234,0.86)] px-4 py-2 text-sm text-slate-500 shadow-soft">{adminShellContent.actions[1]}</div>
                <div className="rounded-full bg-[#d7be8a] px-4 py-2 text-sm font-semibold text-[#08122c] shadow-luxury">{adminShellContent.actions[2]}</div>
              </div>
            </div>
          </div>
