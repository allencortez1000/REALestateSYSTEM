    ...
    <main className="px-4 pb-8 pt-4 sm:px-6 lg:px-8">
      <section className="mx-auto max-w-[1500px]">
        <PageHero
          ...
          description={`${brand.name} presents premium model houses and polished housing options across the Philippines.`}
          contentClassName="xl:flex xl:min-h-[590px] xl:flex-col xl:justify-center xl:px-8 min-[1400px]:px-10"
          asideClassName="bg-[linear-gradient(180deg,#071426_0%,#13273f_100%)] p-4 sm:p-5 xl:flex xl:min-h-[590px] xl:items-center xl:p-6"
          aside={<HeroSlideshow />}
        >
        ...
        <section className="mt-6 rounded-[1.75rem] border border-[rgba(231,220,200,0.95)] bg-[linear-gradient(180deg,rgba(255,255,255,0.94),rgba(247,243,234,0.88))] p-6 shadow-[0_14px_34px_rgba(5,14,30,0.06)] sm:rounded-[2.35rem] sm:p-8">
          ...
          <ResponsiveGrid columns="auto" className="mt-7 xl:grid-cols-3 min-[1500px]:grid-cols-5">
            {homeTypes.map((type, index) => (
              <article key={type.title} className="group rounded-[1.75rem] border border-[#e7dcc8] bg-white p-5 shadow-[0_12px_28px_rgba(5,14,30,0.05)] transition hover:-translate-y-1 hover:shadow-[0_18px_42px_rgba(5,14,30,0.08)]">
                ...
                <div className="mt-3 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#8a6428]">Best for {type.bestFor}</div>
                <p className="mt-4 text-sm leading-7 text-slate-600">{type.text}</p>
                <div className="mt-5 border-t border-[#f0e5d1] pt-4 text-sm font-semibold text-[#071426]">{type.example}</div>
              </article>
            ))}
          </ResponsiveGrid>
        </section>

        <section className="mt-6 overflow-hidden rounded-[2.35rem] border border-[rgba(231,220,200,0.95)] bg-[linear-gradient(135deg,#071426_0%,#0d2342_62%,#13273f_100%)] p-6 text-white shadow-[0_16px_40px_rgba(5,14,30,0.08)] sm:p-8">
          <div className="grid gap-6 xl:grid-cols-[minmax(0,0.85fr)_minmax(360px,1.15fr)] xl:items-center">
            <div>
              ...
              <h2 className="mt-4 text-[clamp(1.95rem,4vw,3rem)] font-semibold leading-[1.04] tracking-[-0.055em] text-white">Preview affordability before you inquire.</h2>
            ...
            <ResponsiveGrid columns="auto" className="md:grid-cols-2 min-[1400px]:grid-cols-3">
              {homePaymentPreviews.map((item) => (
                <article key={item.model} className="rounded-[1.65rem] border border-white/10 bg-white/[0.06] p-5 backdrop-blur-sm">
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-[1.08fr_0.92fr] lg:items-stretch">
          <div className="grid gap-4">
            <section className="rounded-[1.75rem] border border-[rgba(231,220,200,0.95)] bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(247,243,234,0.88))] p-6 shadow-[0_14px_34px_rgba(5,14,30,0.06)] sm:rounded-[2.35rem] sm:p-8">
            ...
            <section className="rounded-[2.35rem] border border-[rgba(231,220,200,0.95)] bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(247,243,234,0.88))] p-6 shadow-[0_14px_34px_rgba(5,14,30,0.06)] backdrop-blur-sm sm:p-8">
          ...
          <aside className="flex">
            <section className="relative flex min-h-full flex-col overflow-hidden rounded-[2.35rem] border border-[rgba(215,190,138,0.30)] bg-[radial-gradient(circle_at_top_left,rgba(215,190,138,0.12),transparent_28%),radial-gradient(circle_at_bottom_right,rgba(255,255,255,0.05),transparent_24%),linear-gradient(160deg,#071426_0%,#0d2342_58%,#13273f_100%)] p-6 text-white shadow-[0_16px_40px_rgba(5,14,30,0.10)] sm:p-8 lg:p-10 xl:p-11">
              ...
              <div className="relative flex flex-1 flex-col">
                <div className="inline-flex items-center rounded-full border border-white/12 bg-white/[0.07] px-4 py-2 backdrop-blur-md">
                  <span className="text-[10px] font-bold uppercase leading-4 tracking-[0.18em] text-[#d7be8a]">{brand.companyName}</span>
                </div>
                ...
                <div className="mt-8 grid flex-1 content-between gap-4">
                  {brandStatements.map((item, index) => (
                    <article key={item.title} className="group rounded-[1.85rem] border border-white/14 bg-[linear-gradient(180deg,rgba(255,255,255,0.10),rgba(255,255,255,0.055))] p-5 shadow-[0_14px_30px_rgba(0,0,0,0.10)] backdrop-blur-sm transition hover:border-[#d7be8a]/40 hover:bg-white/[0.11] sm:p-6">
                      <div>
                        <div className="text-base font-extrabold uppercase leading-6 tracking-[0.18em] text-[#d7be8a] sm:text-lg">{item.title}</div>
        ...
        <section className="mt-6 rounded-[2.35rem] border border-[rgba(231,220,200,0.95)] bg-[linear-gradient(180deg,rgba(255,255,255,0.94),rgba(247,243,234,0.88))] p-6 shadow-[0_14px_34px_rgba(5,14,30,0.06)] sm:p-8">
          <div className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,0.8fr)_minmax(360px,1.2fr)] xl:items-start">
            <div>
              ...
              <h2 className="mt-4 text-[clamp(1.95rem,4vw,3rem)] font-semibold leading-[1.04] tracking-[-0.055em] text-[#071426]">From browsing to reservation, clearly explained.</h2>
            ...
            <div className="grid gap-3 md:grid-cols-2">
              {buyerJourney.map((item) => (
                <article key={item.step} className="rounded-[1.5rem] border border-[#e7dcc8] bg-white p-5 shadow-[0_10px_24px_rgba(5,14,30,0.04)]">
        ...
        <section className="mt-6 overflow-hidden rounded-[2.35rem] border border-[rgba(231,220,200,0.96)] bg-[linear-gradient(135deg,#071426_0%,#0d2342_62%,#13273f_100%)] px-6 py-8 text-white shadow-[0_16px_40px_rgba(5,14,30,0.08)] sm:px-8 sm:py-10">
          <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            <div>
              <div className="section-label text-[#d7be8a]">Start here</div>
              <h2 className="mt-4 text-[clamp(1.95rem,4.2vw,3.05rem)] font-semibold leading-[1.04] tracking-[-0.05em] text-white">Built for buyers, sellers, and administrators in one premium system.</h2>
              <p className="mt-4 max-w-2xl text-base leading-8 text-white/72">Amica Residences is designed to feel modern, calm, and trustworthy with a quietly luxurious finish.</p>
            </div>
            <div className="flex flex-wrap gap-3 lg:justify-end">
              <Link href="/auth/register" className="btn-gold">Create account</Link>
              <Link href="/auth/login" className="btn-outline border-white/18 bg-white/10 text-white hover:bg-white/14 hover:text-white">Login</Link>
            </div>
          </div>
        </section>
      </section>
