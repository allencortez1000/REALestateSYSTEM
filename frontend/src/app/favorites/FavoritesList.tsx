  ...
  if (!hydrated) {
    return (
      <div className="mt-6 grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
        {[1, 2, 3].map((item) => (
          <div key={item} className="min-h-[320px] animate-pulse rounded-[2rem] border border-[#e7dcc8] bg-white/70 p-5 shadow-[0_12px_28px_rgba(9,21,64,0.05)]">
  ...
  if (favoriteListings.length === 0) {
    return (
      <div className="mt-6 rounded-[2rem] border border-[#e7dcc8] bg-white p-8 text-center shadow-[0_14px_34px_rgba(9,21,64,0.06)]">
        ...
        <h2 className="mt-3 text-[1.8rem] font-semibold leading-[1.04] tracking-[-0.045em] text-[#071426]">Start saving model houses</h2>
